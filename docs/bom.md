...
| # | Component | Qty | Est. Price | Link |
|---|-----------|-----|-----------|------|
| 12 | M3x24 screws | 4 | ~$2 | See note below |
| 13 | M3x20 screws | 2 | ~$1 | See note below |
| 14 | M3x16 screws | 2 | ~$1 | See note below |
| 15 | M3x12 screws | 8 | ~$1 | See note below |
| 16 | M3x8 screws | 14 | ~$1 | See note below |
| 17 | M3x6 flat head screws | 2 | ~$1 | See note below |
| 18 | M3 nuts | 10 | ~$1 | See note below |
| 19 | M3 shims | 4 | ~$1 | See note below |
| 20 | M3x12 standoffs (female-male) | 4 | ~$2 | See note below |
| 21 | M3x40 standoffs (female-female) | 4 | ~$2 | [Amazon](https://a.co/d/03zlcVNa) |
...
|---|------|------|-----|----------|
| 22 | Base Plate (bottom deck) | `Marpy_base_plate.STL` | 1 | PLA/PETG |
| 23 | Top Plate (electronics deck) | `Marpy_top_plate.STL` | 1 | PLA/PETG |
| 24 | Left Motor Mount | `Marpy_left_TT_motor_mount.STL` | 1 | PLA/PETG |
| 25 | Right Motor Mount | `Marpy_right_TT_motor_mount.STL` | 1 | PLA/PETG |
| 26 | On/Off Switch Mount | `Marpy_on_off_switch_mount.STL` | 1 | PLA/PETG |
| 27 | Camera Mount | `Marpy_cam_mount.STL` | 1 | PLA/PETG |
| 28 | ESP32-CAM Case | `ESP32_cam_case.stl` | 1 | PLA/PETG |
| 29 *(optional)* | ESP32-CAM Case (GoPro mount) | [Printables](https://www.printables.com/model/837615-esp32-cam-case-with-gopro-mount) | 1 | PLA/PETG |
